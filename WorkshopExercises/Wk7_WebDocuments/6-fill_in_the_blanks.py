...
Word1 = input('A body part: ')
Word2 = input('Your favourite lolly(sweet): ')
Word3 = input('Your favourite chocolate bar: ')
Word4 = input('Another body part: ')
Word5 = input('A pet shop animal (excluding a cat): ')
Word6 = input('An article of female clothing: ')
