...
#    Python code, prompt the user for the address of the web
#    document they want to copy.
web_address = input('Enter web address to copy: ')
...
web_page_text = web_page_bytes.decode('UTF-8', 'backslashreplace')

#open a file to save web page to
html_file = open('dummyfile.html', 'w', encoding = "UTF-8")
