...
#return word with capital letter followed by lower case with one or more characters
...
#return filename either with capital or not, followed by lower case letters with one or more characters
...
#word starts either lower case or upper case
#show rest of first word
#second word starts with a capital
#return rest of word either upper or lower case
...
attempt(findall('>([A-Za-z ]+)</', question))
