...
red_button = Button(buttons, text = 'Cut red wire', command = cut_red)
blue_button = Button(buttons, text = 'Cut blue wire', command = cut_blue)
green_button = Button(buttons, text = 'Cut green wire', command = cut_green)
