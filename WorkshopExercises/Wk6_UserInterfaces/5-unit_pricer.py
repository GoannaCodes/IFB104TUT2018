...
# for.
Price = Spinbox(pricing_window, from_=1, to=99,
                command = calculate)
Quantity = Spinbox(pricing_window, from_=1, to=99,
                command = calculate)
PriceLabel = Label(pricing_window, text = "Enter price ($)")
PriceLabel.grid(row = 1)
Price.grid(row = 2)

QuantityLabel = Label(pricing_window, text = "Enter quantity (kg)")
QuantityLabel.grid(row = 3)
Quantity.grid(row = 4)
...
Results = Label(pricing_window, text = "Unit prices ($)/kg")
