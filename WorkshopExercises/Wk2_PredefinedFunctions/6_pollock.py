...
#Set up screen and define fixed value
screen_size = 215 # pixels
setup(screen_size, screen_size)

pendown()
speed('fastest')

#Select random colour for pen
for step_num in range(100):
   #choose a random colour, width and location
    colour = uniform(0.0, 1.0)
    width = randint(0, 10)
    max_goto = (screen_size - width)
    #co-ordinates to draw dot
    x_pos = randint(-max_goto, max_goto)
    y_pos = randint(-max_goto, max_goto)
    #random pencolor
