...
#setting position of inner circle
penup() #don't start drawing yet
home() #go to centre of screen
goto(radii[0], 0) #go to eastmost point of the circle
...
#setting position of middle circle
penup()
home()
goto(radii[1], 0)
setheading(90)
...
#setting position of outer circle
penup()
home()
goto(radii[2], 0)
setheading(90)
