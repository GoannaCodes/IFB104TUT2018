...
results = [] #create an empty list to hold random numbers

for r in range(number_of_trials):
    number = randint(1, limit_of_random_numbers)
    results.append(number)

print('There were', number_of_trials, 'trials for generating numbers between 1 and 1000')
print('The smallest number generated was', min(results))
print('The largest number generated was', max(results))
