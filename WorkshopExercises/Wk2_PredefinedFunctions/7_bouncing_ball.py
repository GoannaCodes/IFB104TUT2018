...
for bounce in range(20):
    top = randint(-screen_size, screen_size)
    goto(top, screen_size)

    left = randint(-screen_size, screen_size)
    goto(-screen_size, left)

    bottom = randint(-screen_size, screen_size)
    goto(bottom, -screen_size)

    right = randint(-screen_size, screen_size)
    goto(screen_size, right)
