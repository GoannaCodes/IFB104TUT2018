...
Volume = round(pi * (radius **2) * height) #calculating volume as integer
#volume will not be rounded, or expressed as an int if written separately from the original expression
print('Volume of tank is', Volume, 'metres cubed')
